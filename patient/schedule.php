...
$pid = $_SESSION['pid']; // Assuming you have a session variable for the patient ID
$checkBooking = $database->query("SELECT * FROM appointment WHERE scheduleid='$scheduleid' AND pid='$pid'");
$alreadyBooked = ($checkBooking->num_rows > 0);
                                        ...
                                        <td style="width: 25%;">
                                                <div  class="dashboard-items search-items"  >
                                                    ...
                                                    <div style="width:100%">
                                                            ...
                                                            <br>';
                                                            if ($alreadyBooked) {
                                                                echo '<button class="login-btn btn-primary-soft btn" style="padding-top:11px;padding-bottom:11px;width:100%" onclick="showAlreadyBookedPopup()"><font class="tn-in-text">Already Booked</font></button>';
                                                            } else {
    ...
    function showAlreadyBookedPopup() {
